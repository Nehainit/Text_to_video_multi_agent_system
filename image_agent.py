...
from continuity_context import character_definitions, continuity_context
...
DEFAULT_CHARACTER_SHEET_REFERENCE = Path(__file__).with_name("assets") / "character_sheet_layout_reference.png"
