...
with (Path(__file__).parent / "config" / "content_safety.yml").open(encoding="utf-8") as safety_file:
...
with (Path(__file__).parent / "config" / "scene_planning.yml").open(encoding="utf-8") as scene_file:
...
with (Path(__file__).parent / "config" / "visual_planning.yml").open(encoding="utf-8") as visual_file:
...
with (Path(__file__).parent / "config" / "shot_planning.yml").open(encoding="utf-8") as shot_file:
...
with (Path(__file__).parent / "config" / "image_prompt_builder.yml").open(encoding="utf-8") as image_prompt_file:
...
with (Path(__file__).parent / "config" / "shot_image_generation.yml").open(encoding="utf-8") as image_generation_file:
...
with (Path(__file__).parent / "config" / "shot_image_qa.yml").open(encoding="utf-8") as image_qa_file:
...
with (Path(__file__).parent / "config" / "motion_planning.yml").open(encoding="utf-8") as motion_file:
...
with (Path(__file__).parent / "config" / "shot_video_generation.yml").open(encoding="utf-8") as video_generation_file:
...
with (Path(__file__).parent / "config" / "video_validation.yml").open(encoding="utf-8") as video_validation_file:
    VIDEO_VALIDATION_CONFIG = yaml.safe_load(video_validation_file)["video_validation"]

with (Path(__file__).parent / "config" / "judge_panel.yml").open(encoding="utf-8") as judge_panel_file:
